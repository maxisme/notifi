...
<body>
	...
	<page id="howitworks">
		...
		<div>
			<p class="info">
				Notifi is a <strong>FREE</strong>, minimal <strong>Push Notification app</strong> that sits in your Mac menu bar. When you open the app for the first time you are given a key that uniquely identifies you. <em>Blurred in the image below:</em>
			</p>
			<p>
				<img style="zoom:98.6%" src="https://github.com/maxisme/notifi/raw/master/Screen%20Shots/Menubar.png">
			</p>
			<p class="info">
				With this key you can send <a target="_blank" href="https://github.com/maxisme/notifi#http-request-examples">HTTP requests (curl)</a> to receive notifications on your mac.
			</p>
			<p>
